...
/*added for ResourceAdded/ResourceRemoved/Alert/ResourceUpdated/StatusChange/ subscription Begin:*/
    request.m_event_content = params["event_content"].asString();
    request.m_event_OriginOfCondition = params["event_origin_of_condition"].asString();
    request.m_event_message_id = params["event_message_id"].asString();
    request.m_event_oem = params["Oem"];

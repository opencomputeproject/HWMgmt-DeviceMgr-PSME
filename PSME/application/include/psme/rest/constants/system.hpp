...
extern const char MEMROY_STATUS[];
extern const char CPU_STATUS[];
extern const char STORAGE_STATUS[];
...
extern const char FR_MEMROY_PERCENTAGE[];
extern const char GRUB_DEFAULT[];
extern const char GRUB_BOOT_SOURCE_OVERRIDE_TARGET[];
extern const char COMPUTER_SYSTEM_GRUB_DEFAULT[];
extern const char COMPUTER_SYSTEM_GRUB_BOOT_SRC_TARGET[];
extern const char COMPUTER_SYSTEM_GRUB_BOOT_SRC_TARGET_TEST[];
extern const char ALLOWABLE_GRUB_TYPES[];
extern const char ALLOWABLE_GRUB_BOOT_TARGET_TYPES[];
}
